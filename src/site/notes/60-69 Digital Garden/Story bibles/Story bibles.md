---
{"dg-publish":true,"dg-permalink":"story_bibles","permalink":"/story_bibles/","dg-note-properties":{}}
---
...
A master directory of active settings and universes. Each link connects to a dedicated note containing the core lore, subcategories, and individual books for that project.

***

### 🪐 Primary Realms

#### [[Project Kalpa\|Project Kalpa]]
*Complete world design, foundational cosmology, and localized unrecorded histories.*

#### [[HP Worldbuild\|HP Worldbuild]]
*An archive of expanded magical mechanics, historical diversions, and personal lore.*

***

### 📂 Series & Universes

#### [[20-29 The Study/20 Writing/20.00 Projects A-D/B/BTL/Built To Last\|Built To Last]]
*Main hub for the interconnected series, housing core timeline documentation and individual book files:*
* `Built For Sin (BTL-S)`
* `Built For Grace (BTL-G)`
* `Built For Ruin (BTL-R)`

#### [[20-29 The Study/20 Writing/20.04 Projects Q-T/T/TKG/The King\|The King]]
*Main hub for the series lore, housing regional foundations and book files:*
* `Bran Bec (TKG-B)`

***

### 🖋️ Standalone Projects
*Individual folders containing the specific setting lore and manuscript notes for each standalone story.*
